/*COSC 3250 - Project 5
*context switch
*@author Franco Presta, Timi Ladeinde
*Instructor Professor Brylow
*TA - BOT:MAILTO [francesco.presta@marquette.edu] [olurotimi.ladeinde@marquette.edu]
*/
...
void xtrap(long *frame, int cause)
{
	...
	frame[CTX_R0] = syscall_dispatch( 0xffffff & temp,(int *)frame);
